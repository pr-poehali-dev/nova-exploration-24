...
const faqs = [
  {
    ...
    answer:
      "Студия базируется в Новосибирске, но выполняем проекты по всей России. Выезд на замер и монтаж осуществляем в Новосибирске — другие города обсуждаем индивидуально.",
  },
  {
